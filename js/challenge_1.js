...
　// 末吉
  ...
  // 書き出す
  switch (td2.innerHTML) {
    case "大吉":
      td3.innerHTML = pronumbers[0].toFixed(0) + "％";
      break;
    case "中吉":
      td3.innerHTML = pronumbers[1].toFixed(0) + "％";
      break;
    case "小吉":
      td3.innerHTML = pronumbers[2].toFixed(0) + "％";
      break;
    case "吉":
      td3.innerHTML = pronumbers[3].toFixed(0) + "％";
      break;
    case "末吉":
      td3.innerHTML = pronumbers[4].toFixed(0) + "％";
      break;
    case "凶":
      td3.innerHTML = pronumbers[5].toFixed(0) + "％";
      break;
    case "大凶":
      td3.innerHTML = pronumbers[6].toFixed(0) + "％";
      break;
  }
